...
import static com.gromart.kunal.myapplication.ListAdapter.KEY_MEAL;
...
//        mproductlist.setAdapter(firebaseRecyclerAdapter);
    ...
    private void firebaseSearch(final String search){
        ...
        final FirebaseRecyclerAdapter firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<ImageUploadInfo, BlogViewHolder>(options) {
            @Override
            public BlogViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.product_row, parent, false);
            ...
            protected void onBindViewHolder(@NonNull BlogViewHolder viewHolder, int position, @NonNull ImageUploadInfo model) {
                ...
                if (search == null){
                    ...
                    if (model.getImageName().contains(search)){
